...
resource "google_billing_budget" "relative_amount_budget" {
  ...
  display_name    = "Relative budget alert for project ${data.google_project.project.project_id} (Number ${data.google_project.project.number})"
...
resource "google_billing_budget" "absolute_amount_budget" {
  ...
  billing_account = var.budgets.billing_account_id
  display_name    = "Absolute budget alert for project ${data.google_project.project.project_id} (Number ${data.google_project.project.number})"
